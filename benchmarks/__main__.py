...
def __main__():
    ...
    bc_args_set = [[], ['-nocoi'], ['-nots'], ['-nosimplify'], ['-nocoi', '-nots'], ['-nocoi', '-nosimplify'], ['-nots', '-nosimplify'], ['-nocoi', '-nots', '-nosimplify']]
    bits = 4
    count = 1
    ...
    for i in range(0, len(s)):
        ...
        print(s[i])
        print("=STATISTICS=")
        print("min: " + str(min(all_times)) + " max: " + str(max(all_times)) + " avg: " + str(sum(all_times) / len(all_times)))
        print("\n\n")
