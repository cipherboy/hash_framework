    ...
    def pre_run(self):
        ...
        if not os.path.exists(cache_path):
            ...
            if self.create_cache_dir(cache_dir_path):
                ...
                models.vars.write_assign(['ccollision', 'cblocks', 'cstate', 'cdifferentials', 'czeroes'])
        ...
        f.write("czeroes := [" + str(self.zeroes) + "," + str(self.zeroes) + "](" + ','.join(map(lambda x: 'NOT(h1b' + str(x) + ')', range(512))) + ");")
        f.flush()
        f.close()
