...
class Minimal(Kernel):
    ...
    def build_tag(self):
        return str(self.jid) + self.build_cache_tag() + "-e" + '-'.join(list(map(str, self.bits)))
    ...
    def pre_run(self):
        ...
        attacks.collision.differentials.write_path(self.algo, differential_path, clause="cdifferentials", name=base_path + "/09-differential.txt")
