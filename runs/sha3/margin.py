...
for in_margin in range(input_error, 25*w):
    ...
    while min_v < max_v:
        ...
        hf.models.vars.write_range_clause('cinput', input_error, input_error, cinput, '50-input.txt')

        tail = '*'*out_margin
        coutput = hf.models.vars.differential(tail, 'h1o', 0, 'h2o', 0)
        hf.models.vars.write_range_clause('coutput', out_error, out_error, coutput, '50-output.txt')
