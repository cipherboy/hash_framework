...
def __main__():
    ...
    q = "SELECT id, run_return, run_time, args FROM jobs WHERE task_id=" + str(tid) + " AND state=2 AND run_time > 75000 AND run_time < 3600000 ORDER BY run_time DESC;"
    ...
    while row != None:
        ...
        print("%d %s %d %d %d %d # %s %s %d" % (w, rounds, input_error, input_margin, output_error, output_margin, algo, sat, run_time))
