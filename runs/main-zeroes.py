...
if __name__ == "__main__":
    ...
    # Zeroes / Ones
    # Ascii
    work = kernel.gen_work(48, [dobbertins_base, wangs_base, schlaffers_base, kasselman_base, sasakis_base])
    ...
    work_mapped = list(map(lambda y: kernel.work_to_args("md4", y, start_state=start_state, start_block=start_block), work))
